#!/usr/bin/env python3
"""skel2glb — Convert AniMo skeleton sequences to mesh-animated GLB files.

V1 (GLB-based): requires a reference GLB with 143 joints and full skinning.

Usage:
    python skel2glb.py skeleton.npy reference.glb --output out.glb
    python skel2glb.py skeleton.npy reference.glb --mode vecs --fps 30
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Convert AniMo skeleton .npy to mesh-animated GLB",
    )
    ...
    parser.add_argument("--output", type=str, default=None,
                        help="Output GLB path (default: <npy_stem>_mesh.glb)")
    ...
    if args.output:
        ...
        out_path = npy_path.with_name(npy_path.stem + "_mesh.glb")
    ...
    # Retarget
    print("Retargeting ...")
    local_rots, root_trans, tracked = retarget(positions, glb_data)
